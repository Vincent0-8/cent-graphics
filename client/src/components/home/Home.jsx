        ...
        <main>
            ...
            <div id="services" className="container-offer">
                    ...
                    <div className="feature-list">
                        <div className="feature">
                            <div className="feature-icon1"><MdPalette /></div>
                            <h3>Color Palettes Collection</h3>
                            <p>Elevate your brand with unique and memorable visual identities. From logos to comprehensive style guides, we create designs that truly represent your business.</p>
                        </div>
                        <div className="feature">
                            <div className="feature-icon2"><MdPalette /></div>
                            <h3>Typography Collections</h3>
                            <p>Explore a diverse range of typography collections designed to bring clarity and personality to your brand. Each font is carefully selected to enhance readability and visual impact.</p>
                        </div>
                        <div className="feature">
                            <div className="feature-icon3"><MdPalette /></div>
                            <h3>Saving Option</h3>
                            <p>Create and save your favorite color palettes for easy access and future use. Build your personalized collection of inspiring color combinations tailored to your design preferences.</p>
                        </div>
                    </div>
            </div>
            ...
            <div className="container-palettes">
                ...
                {palettes.map(palette => (
                    <div key={palette.id} className={`palette-edition ${palette.editionClass}`}>
                                    ...
                                    <div className="palette-colors">
                                        {p.colors.map(color => (
                                            <div key={color} className="color-item">
                                                ...
                                                <p className="hex-code" onClick={() => handleCopy(color)}>{isCopied === color ? "Copied!" : color}</p>
                                            </div>
                                        ))}
                                    </div>
                ...
                <div className="typography-card">
                    ...
                    <div className="typography-body">
                        <div className="typo-left">
                            ...
                            <p className="typo-tagline">Conveying your message through the power of design.</p>
                        </div>
                ...
                <div className="typography-card font-playfair">
                    ...
                    <div className="typography-body">
                        <div className="typo-left">
                            ...
                            <p className="typo-tagline">Elegant and timeless typography for your brand.</p>
                        </div>
            ...
            <div id="contact" className="contact">
                <div className="container-contact">
                    <div className="contact-info">
                        ...
                        <p>Apex Creative Agency <br />456 Enterprise Boulevard <br />USA</p>
                    ...
                    <div className="contact-service">
                        ...
                        <a href="/#palettes" className="contact-subtitle">Palettes</a>
                        <a href="/#typography" className="contact-subtitle">Typography</a>
                    </div>

                    <div className="contact-social">
                        <h1 className="contact-title">Socials</h1>
                        <a href="" className="contact-subtitle">Instagram</a>
                        <a href="" className="contact-subtitle">Behance</a>
                        <a href="" className="contact-subtitle">Dribbble</a>
                    </div>
                </div>

                <div className="container-footer"><strong>Cent Graphic &copy; 2026</strong></div>
